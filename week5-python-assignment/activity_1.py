...
class Superhero(ABC):
    ...
    Demonstrates encapsulation with private attributes and abstract methods.
    """
    ...
    def use_power(self) -> str:
        """Each superhero must implement their unique power."""
        pass
...
class TechHero(Superhero):
    ...
    def _initialize_gadgets(self):
        ...
        advanced_gadgets = ['Energy Shield',
                            'Holographic Projector', 'Nano Repair Kit']
...
def demo_superhero_system():
    ...
    superman = FlyingHero("Superman", "Clark Kent",
                          flight_speed=500, health=95)
    batman = TechHero("Batman", "Bruce Wayne",
                      gadget_count=8, tech_level=3, energy=90)
    iron_man = HybridHero("Iron Man", "Tony Stark",
                          flight_speed=300, tech_level=5)
